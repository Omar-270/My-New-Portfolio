...
// Replace the old DECI Level 2 PDF preview with the uploaded JPEG.
const deciCard=document.querySelector('a.certificate[href="certificates/DECI_2.pdf"]');
if(deciCard){
  deciCard.href='certificates/DECI_2.jpg';
  const preview=deciCard.querySelector('div[style*="height:260px"]');
  if(preview){
    const img=document.createElement('img');
    img.src='certificates/DECI_2.jpg';
